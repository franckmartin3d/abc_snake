...
class Snake {
  ...
  move() {
    ...
    else if (this.snakebody[0].y > canvas.height) {
      console.log("hitting up, canvas.height", canvas.height);
      console.log("snake pos y,", this.snakebody[0].y );
  ...
  collision() {
    ...
    if (this.snakebody.length > 3) {
      ...
      for (let i = 3; i < this.snakebody.length; i++) {
        ...
        if (part.x == this.snakebody[0].x && part.y == this.snakebody[0].y) {
